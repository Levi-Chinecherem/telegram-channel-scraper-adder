...
if len(channels) == 0:
    print("No channels found. Please join a channel first.")
    sys.exit()
...
channel_index = input("Enter the number: ")
target_channel = channels[int(channel_index)]

target_channel_entity = InputPeerChannel(target_channel.channel_id, target_channel.access_hash)
